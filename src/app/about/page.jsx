        ...
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                <p className={styles.intro}>
                    Hi there! I'm <span className={styles.name}>Hafidh</span>, a passionate software engineer with  in a variety of technologies. I have <span className={styles.experience}>2</span> years of experience in developing robust and scalable web applications using a range of tools and frameworks.
                </p>
